...
Analizando algebráicamente el kernel, se puede observar que este 
...
es una opcion :)). Por lo tanto, a pesar de la enorme reduccion en tiempo de ejecucion,
...
aun hay margen de mejora, pero estas se escapan de mis capacidades actuales.
